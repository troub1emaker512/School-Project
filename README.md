...
### 1. Game Project
A browser-based interactive project built with p5.js. This folder includes the main HTML entry point, JavaScript sketch logic, sound libraries, and project assets.

### 2. ITP2 Final Project
A web-based drawing application with multiple tools such as brush, eraser, freehand drawing, mirror drawing, polygon tools, stamps, and colour selectors. The project was extended with additional features such as a spectrum selector and editable shapes.

### 3. WD Final (Team 100)
A team web development coursework submission containing code and a written report. This project represents collaborative frontend and web design work produced as part of a group assignment.

### 4. CM2030 GP Finals
An image-processing coursework project built in JavaScript with p5.js. The file names suggest functionality for image conversion, image processing, and channel splitting.
